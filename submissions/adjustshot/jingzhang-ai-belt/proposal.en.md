...
The main brand "JZ-IA / Zhi-Mai Jing-Zhang" adopts a **finalized logo** (AI-generated original, no third-party trademark/portrait dependencies):

![JZ-IA final Logo](assets/figures/logo_v5_zhimai.jpg)

**Graphic anatomy** (three elements mapping the theme):
- **Ring = symbiotic belt**: bold navy circular ring, representing the belt where AI innovation and century-old railway heritage coexist
- **Continuous flowing ren curve = intelligent artery**: an unbroken line (like an ECG pulse) flowing from the historical end, cresting at the switchback apex, and toward the future end — simultaneously the abstract of the Qinglongqiao ren-shaped railway and a single intelligent artery
- **Brick-red node at apex = AI origin**: the 1909 switchback point elevated into the 2026 innovation origin
...
① Node gateway · 5m ren-shaped steel landmark tower (luminous ring with embedded logo)｜ ② Corridor · ground ren-shaped dual-track paving motif + intelligence lamp lantern top identifier｜ ③ Cultural · T-shirt single-color navy print｜ ④ Cultural · enamel fridge magnets / badges / mug
...
| S12 Safety sandbox | Zhongzhi Park | B1 Stack Sanctuary | Institute + standards body | TRL 7 | PRC Generative AI Measures + EU AI Act (2024/1689) + US NIST AI RMF 1.0 | Test-set de-identification; isolated net | Isolated rollback | Standards-body certification | Exit if vulnerability closure >90 days | Vulnerability closure ≤90 days | Mid-long |
